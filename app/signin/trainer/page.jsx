...
export default function TrainerSignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("[v0] Starting signin process for trainer")
    ...
    try {
      ...
      console.log("[v0] Redirecting to trainer dashboard...")
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/signup/trainer" className="text-[#4e97fd] hover:underline font-medium">
                Create an account
              </Link>
            </p>
          </div>
