...
export default function TraineeTrainingCompany() {
  return (
    <div className="flex min-h-screen bg-gray-50">
      <TraineeSidebar currentPath="/trainee/training-company" />
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="ml-64 flex-1 p-6 overflow-hidden">
          ...
          <div className="px-6 mb-8 mt-20">
            ...
            <div className="rounded-3xl border-2 border-gray-300 p-6 shadow-sm h-[200px] mb-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-[150px] h-[150px] p-2 rounded-full overflow-hidden border-2 border-gray-400">
                    <img
