...
export default function TraineeSettings() {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      // Clear client-side data and redirect
      logout()
    } catch (error) {
            ...
            <div className="flex-1 p-8 bg-white rounded-xl shadow-md">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-16 mb-16">
                  {/* General Settings */}
                  <div>
                    <h2 className="text-2xl font-bold text-black mb-8">General settings</h2>

                    <div className="space-y-8">
                      {/* Notification Setting */}
                      <div>
                        <h3 className="text-lg font-semibold text-black mb-2">Notification Setting</h3>
                        <p className="text-gray-600 mb-4">
                          You are enable or disable the notification setting from here.
                        </p>
                      ...
                      {/* Roles Allow */}
                      <div>
                        <h3 className="text-lg font-semibold text-black mb-2">Roles allow</h3>
                        <p className="text-gray-600 mb-4">Select roles show to all users</p>
                    ...
                    {/* Purchase Settings */}
                    <div>
                      <h2 className="text-2xl font-bold text-black mb-8">Purchase settings</h2>

                      <div className="space-y-8">
                        {/* Payments Available */}
                        <div>
                          <h3 className="text-lg font-semibold text-black mb-2">Payments Available</h3>
                          <p className="text-gray-600 mb-4">Select the available Option at a time for payments</p>
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-black mb-2">General notification sound</h3>
                          <p className="text-gray-600 mb-4">You can select the notification Sound for App</p>
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-black mb-8">Notification settings</h2>

                    <div className="grid grid-cols-2 gap-16">
                      {/* Updates Toggle */}
                      <div className="flex items-center justify-between">
                        <span className="text-lg font-medium text-black">Updates</span>
                        <button
                      ...
                      {/* Billings Toggle */}
                      <div className="flex items-center justify-between">
                        <span className="text-lg font-medium text-black">Billings</span>
                        <button
                  ...
                  <div className="mt-16 pt-8 border-t border-gray-200">
                    <h2 className="text-2xl font-bold text-black mb-4">Account Actions</h2>
                    <p className="text-gray-600 mb-6">Sign out of your account or manage your session</p>
                    <button
                      onClick={handleLogout}
                      disabled={isLoggingOut}
                      className="flex items-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-xl font-medium transition-colors"
                    >
