...
const additionalNav = [
  {
    ...
    href: "/trainer/spending-history",
    icon: History,
  },
  { name: "Setting", href: "/trainer/settings", icon: Settings2 },
  {
    name: "Support Tickets",
    href: "/trainer/support-tickets",
    icon: HelpCircle,
  },
  {
    name: "Account Settings",
    href: "/trainer/account-settings",
    icon: Settings,
  },
];
